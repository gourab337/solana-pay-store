...
/// Check if user has purchased on load
// Return true if a given public key has purchashed an item before
export const hasPurchased = async (publicKey, itemID) => {
    ...
    if (response.status === 200) {
        ...
        if (json.length > 0) {
            // Check if there any records with this buyer and item ID
